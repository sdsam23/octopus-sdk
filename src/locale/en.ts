export default {
    ...
    'All emissions': 'All the series',
    'Filter by keyword : ': 'Filter by keyword : ',
    'Look for participant name': 'Search for participant by name',
    'Look for productor name': 'Search for Producer by name',
    'Look for emission name': 'Search for serie by name',
    'Look for podcast name': 'Search for podcast by name',
    ...
    'Type string to filter by categories': 'Filter categories by name',
    Search: 'Search',
    Close: 'Close',
    Embed: 'Player',
    ...
    'Subscribe to this participant': "Subscribe to this participant",
    'Emission have not podcasts': "This serie does not have any podcasts",
    'Participant have not podcasts':
      'Participant is not associated to any podcasts',
    ...
    'Podcast published in future': 'Podcast published in future',
    'Podcast in process': 'Podcast in process',
    'Podcast in error': 'Podcast in error',
    'See podcasts not visible to the audience':
      'See podcasts not visible to the audience',
    '{nb} of podcasts': '{nb} of podcasts',
    '{nb} of series': '{nb} of series',
    '{nb} of participants': '{nb} of participants',
    '{nb} of Producers': '{nb} of Producers',
    ...
    'Consider podcasts no visible':
      'Consider podcasts notvisible for the audience',
    'Hosted by': 'Hosted by',
    TutoMag: 'TutoMag',
    News: 'News',
    ...
    'Display emission name': "Display the serie name",
    'Display participants list': 'Display the participants list',
    ...
    'Look for playlist name': 'Look for playlist by name',
    ...
    'Playlist name image': 'Playlist name {name}',
